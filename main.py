...
class Player(pg.sprite.Sprite):
    ...
    def load_animations(self):
        ...
        for i in range(num_images):
            ...
            rect = pg.Rect(x, y, tile_size, tile_size) # Прямоугольникб который определяет областьизображения
...
class Game:
    ...
    def setup(self):
        ...
        # self.crab = Crab(self.map_pixel_width, self.map_pixel_height, [9, 10], [11, 10])
    ...
    def draw(self):
        ...
        text = font.render(f"Coins: {self.collected_coins}", True, "green")
